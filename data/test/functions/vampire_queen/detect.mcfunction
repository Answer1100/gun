...
execute at @a if entity @e[type=minecraft:zombie,name="懶惰的吸血鬼",distance=0.01..10] if predicate test:chance5 if predicate test:hurttime run effect give @e[type=minecraft:zombie,name="懶惰的吸血鬼",distance=..10] instant_damage 1 0
